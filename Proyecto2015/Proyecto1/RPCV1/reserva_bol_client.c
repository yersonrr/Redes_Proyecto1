...
#ifndef	DEBUG
	clnt = clnt_create (host, RESERVA_BOL, RESERVAL_BOL_VERS, "tcp");
	if (clnt == NULL) {
	...
	while (1) {
		...
		switch (*answer) {
	    	case 0:
	    		...
	    		exit(0);
	    	case 1:
	    		printf("Puesto ocupado, ingrese numero de fila y columna (<fila> <columna>): ");
	    		scanf("%d %d", &r, &c);
	    		break;
	    	case 2:
	    	...
	    	case 3:
	    		...
	    		exit(0);
	    	default:
	    		printf("El servidor esta presentando una falla. Recibido: %d.\n", *answer);
	    		exit(0);
		}
	}
